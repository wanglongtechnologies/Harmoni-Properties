  ...
  <main class="bg-tiles mx-auto mt-32 flex flex-col gap-y-10">
    <section data-aos="fade-in" class="relative isolate px-6 py-14 lg:py-20">
      ...
      <div class="mx-auto max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
        <div class="mx-auto max-w-5xl text-center">
          <h1 class="text-2xl font-medium tracking-tight text-balance text-gray-600 sm:text-4xl"><?= __("Sustainability") ?></h1>
          <h1 class="mt-2 font-serif text-6xl font-semibold tracking-tight text-balance text-gray-800 capitalize sm:text-7xl"><?= __("Sustainability Isn’t Just An Initiative—It’s A Responsibility") ?></h1>
        ...
        <div class="mt-16 flow-root sm:mt-24">
          <div class="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-gray-900/10 ring-inset xl:-m-4 xl:rounded-2xl xl:p-4">
            <img id="hero-carousel" src="/assets/img/20250326 - icons and pics/Sustainability banner.png" alt="App screenshot" class="aspect-video rounded-md object-cover object-bottom shadow-2xl ring-1 ring-gray-900/10 transition duration-700 ease-in-out" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section data-aos="fade-in" class="bg-tear py-14 lg:py-20">
      <div class="mx-auto flex w-full max-w-2xl flex-col gap-y-14 px-6 py-10 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
        <div>
          <h2 class="mt-2 text-center font-serif text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-6xl"><?= __("Our ESG Commitment") ?></h2>
          <p class="mt-4 text-center text-lg text-pretty text-gray-600">
    ...
    <section data-aos="fade-in" class="bg-tiles py-14 lg:py-20">
      <div class="mx-auto flex w-full max-w-2xl flex-col gap-y-14 px-6 py-10 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
        <div>
          <h2 class="mt-2 text-center font-serif text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-6xl"><?= __("Our ESG Pillars") ?></h2>
        </div>
    ...
    <section data-aos="fade-in" class="bg-tear z-10 py-14 lg:py-20">
      <div class="mx-auto flex w-full max-w-2xl flex-col gap-y-14 px-6 py-10 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
        <div>
          ...
          <p class="mt-4 text-center text-lg text-pretty text-gray-600"><?= __("Our ESG pillars aren’t just principles—they’re promises.") ?></p>
        </div>
        ...
        <div class="grid w-full grid-cols-1 gap-2 lg:grid-cols-3">
          <div class="flex flex-col items-center justify-center gap-2 rounded-lg bg-gray-300 px-4 py-14 shadow-md lg:py-10">
            <img src="/assets/img/20250326 - icons and pics/Design & Features - Sustainability You Can Trust.png" class="size-32" />
            <h3 class="text-center font-serif text-3xl font-semibold text-gray-800"><?= __("Sustainability You Can Trust") ?></h3>
            <p class="text-center text-lg text-gray-800"><?= __("From design to materials, every decision reflects our commitment to the environment") ?></p>
          </div>
          <div class="flex flex-col items-center justify-center gap-2 rounded-lg bg-gray-300 px-4 py-14 shadow-md lg:py-10">
            <img src="/assets/img/20250326 - icons and pics/Sustainability - Communities That Thrive.png" class="size-32" />
            <h3 class="text-center font-serif text-3xl font-semibold text-gray-800"><?= __("Communities That Thrive") ?></h3>
            <p class="text-center text-lg text-gray-800"><?= __("Thoughtfully crafted spaces that bring people together and support healthier, happier lifestyles") ?></p>
          </div>
          <div class="flex flex-col items-center justify-center gap-2 rounded-lg bg-gray-300 px-4 py-14 shadow-md lg:py-10">
            <img src="/assets/img/20250326 - icons and pics/Sustainability - Integrity That Builds Confidence.png" class="size-32" />
            <h3 class="text-center font-serif text-3xl font-semibold text-gray-800"><?= __("Integrity That Builds Confidence") ?></h3>
            <p class="text-center text-lg text-gray-800"><?= __("Transparent processes and ethical practices you can rely on") ?></p>
          </div>
        </div>

        <p class="mt-4 text-center text-lg text-pretty text-gray-600"><?= __("When you choose Harmoni, you’re choosing more than a home—you’re choosing a better future for yourself and your community.") ?></p>
      </div>
    </section>
  </main>
