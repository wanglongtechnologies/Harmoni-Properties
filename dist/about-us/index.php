  ...
  <main class="bg-tiles mx-auto mt-32 flex flex-col gap-y-10">
    <section data-aos="fade-in" class="relative isolate px-6 py-14 lg:py-20">
      ...
      <div class="mx-auto max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
        <div class="mx-auto max-w-5xl text-center">
          <h1 class="text-xl font-medium tracking-tight text-balance text-harmoni-dark-brown sm:text-3xl"><?= __("About Us") ?></h1>
          <h1 class="mt-2 font-serif text-5xl font-semibold tracking-tight text-balance text-harmoni-dark-brown capitalize sm:text-6xl"><?= __("Shaping Spaces, Inspiring Lives") ?></h1>
        ...
        <div class="mt-16 flow-root sm:mt-24">
          <div class="-m-2 rounded-xl bg-harmoni-light-brown p-2 ring-1 ring-gray-900/10 ring-inset xl:-m-4 xl:rounded-2xl xl:p-4">
            <img id="hero-carousel" src="/assets/img/element/website element_Tentang Kami banner.png" alt="App screenshot" class="bg-white aspect-video rounded-md object-cover shadow-2xl ring-1 ring-gray-900/10 transition duration-700 ease-in-out" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section data-aos="fade-in" class="bg-tiles py-14 lg:py-20">
      <div class="relative hidden 2xl:block">
        ...
        <img src="/assets/img/new element/redesign web-08.png" class="max-w-128 absolute right-0 translate-x-3/5 top-0 translate-y-[900%]" />
      </div>
      <div class="mx-auto flex w-full max-w-2xl flex-col gap-y-14 px-6 py-10 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
        ...
        <h2 class="text-center font-serif text-5xl font-semibold tracking-tight text-pretty text-harmoni-dark-brown sm:text-6xl"><?= __("Our Story") ?></h2>
        ...
        <h2 class="text-center font-serif text-5xl font-semibold tracking-tight text-pretty text-harmoni-dark-brown sm:text-6xl"><?= __("Our Core Values") ?></h2>
        <div class="mx-auto grid grid-cols-1 gap-x-8 gap-y-16">
          <div class="flex flex-col">
            <img src="/assets/img/new element/20250326 - icons and pics/20250326 - icons and pics_About us - Service Excellence.png" class="mx-auto size-32 lg:mx-0" />
            <p class="text-center font-serif text-4xl font-semibold text-harmoni-dark-brown lg:text-left"><?= __("Service Excellence") ?></p>
            <p class="mt-2 text-center text-lg text-harmoni-dark-brown lg:text-left"><?= __("Our commitment to service excellence is unwavering. We pride ourselves on providing superior quality services and products. This excellence is not just in what we deliver but how we deliver it – with professionalism, expertise, and a keen eye for detail.") ?></p>
          </div>

          <div class="flex flex-col">
            <img src="/assets/img/new element/20250326 - icons and pics/20250326 - icons and pics_About us - Reliability.png" class="mx-auto size-32 lg:mx-0" />
            <p class="text-center font-serif text-4xl font-semibold text-harmoni-dark-brown lg:text-left"><?= __("Reliability") ?></p>
            <p class="mt-2 text-center text-lg text-harmoni-dark-brown lg:text-left"><?= __("Reliability is the cornerstone of our customer promise. We’ve built a reputation for being consistently dependable and trustworthy. Our clients know that they can count on us for stability and consistency, which is crucial in today’s ever-changing business landscape.") ?></p>
          </div>

          <div class="flex flex-col">
            <img src="/assets/img/new element/20250326 - icons and pics/20250326 - icons and pics_About us - Innovative Solutions.png" class="mx-auto size-32 lg:mx-0" />
            <p class="text-center font-serif text-4xl font-semibold text-harmoni-dark-brown lg:text-left"><?= __("Innovative Solutions") ?></p>
            <p class="mt-2 text-center text-lg text-harmoni-dark-brown lg:text-left"><?= __("We don’t just solve problems; we innovate. Our team is dedicated to finding creative and effective solutions to the most challenging customer problems. Our approach to innovation ensures that we provide cutting–edge solutions that add real value to our clients.") ?></p>
          </div>

          <div class="flex flex-col">
            <img src="/assets/img/new element/20250326 - icons and pics/20250326 - icons and pics_About us - Transparency.png" class="mx-auto size-32 lg:mx-0" />
            <p class="text-center font-serif text-4xl font-semibold text-harmoni-dark-brown lg:text-left"><?= __("Transparency") ?></p>
            <p class="mt-2 text-center text-lg text-harmoni-dark-brown lg:text-left"><?= __("We maintain clear, honest communication with all our stakeholders. This transparency builds trust and ensures that everyone we deal with, from clients to partners like you, is always informed and engaged in our mutual journey to success.") ?></p>
          </div>

          <div class="flex flex-col">
            <img src="/assets/img/new element/20250326 - icons and pics/20250326 - icons and pics_About us - Responsiveness.png" class="mx-auto size-32 lg:mx-0" />
            <p class="text-center font-serif text-4xl font-semibold text-harmoni-dark-brown lg:text-left"><?= __("Responsiveness") ?></p>
            <p class="mt-2 text-center text-lg text-harmoni-dark-brown lg:text-left"><?= __("Our rapid and effective response to customer needs and feedback sets us apart. We understand the importance of being agile and attentive in our interactions, ensuring that our clients’ needs are promptly met with efficiency and care.") ?></p>
          </div>
        </div>
